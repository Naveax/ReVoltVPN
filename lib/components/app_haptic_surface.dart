...
///
/// Pointer events are observed instead of wrapping every individual button, so
/// existing and future controls receive the same haptic behavior. A small
/// movement/time gate avoids vibrating at the end of normal scroll gestures.
