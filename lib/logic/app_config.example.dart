...
abstract final class AppConfig {
  ...
  /// Public HTTPS base URL for the Rust API. Session possession nonces are
  /// bearer credentials, so the client refuses plaintext, cross-origin and
  /// redirect-based control-plane requests.
  static const String hivemindApiPublic =
      'https://YOUR_DOMAIN/api'; // ◄── REPLACE
  ...
  static const String githubOwner =
      'YOUR_GITHUB_USERNAME'; // ◄── REPLACE (current: 'esefxdz')
  static const String githubRepo =
      'YOUR_REPO_NAME'; // ◄── REPLACE (current: 'ReVoltVPN')
