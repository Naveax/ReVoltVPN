...
void main() {
  ...
  final core = File(
    '${root.path}/android/src/main/kotlin/com/github/tfox/flutter_vless/xray/core/XrayCoreManager.kt',
  );
  ...
  if (before.contains(directCapture) || before.contains(scopedCapture)) {
    stdout.writeln('[secure-socks scope fix] already current: ${core.path}');
    return;
  }
